...
execute at @e[tag=warped_boss_marker,tag=pos2,limit=1] at @s run playsound minecraft:block.glass.break master @a[tag=playing_warp] ~ ~ ~ 15
execute at @e[tag=warped_boss_marker,tag=pos2,limit=1] at @s run playsound minecraft:block.soul_sand.place master @a ~ ~ ~ 10 0.1
